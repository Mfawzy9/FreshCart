...
export default function NotFound() {
  ...
  return (
    <div className="container min-h-screen py-24 flex items-center">
      ...
      <div className="flex-1 min-h-full min-w-full pt-24 items-center text-center md:flex md:text-left ">
        <div className="w-full md:w-1/2">
          <div className="mb-10  md:mb-10">
            <h1 className="text-4xl font-black  mb-10 lg:text-5xl">
          ...
          <div className="mb-10 md:mb-0">
            {userLogin && (
              <Link to={"/"}>
                <button className="text-lg  outline-none py-3 text-white px-5 bg-blue-700 rounded-lg focus:outline-none transform transition-all hover:scale-110  hover:text-gray-50 dark:bg-blue-900">
                  Back to Homepage
                </button>
              </Link>
            )}
