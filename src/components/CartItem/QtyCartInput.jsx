      ...
      >
        ...
        <div className="flex items-center max-w-[8rem]">
          ...
          <input
            ...
            onBlur={
              qtyLoading || product?.product?.count === count
                ? null
                : updateCountEvent
            }
            type="number"
        ...
        <button
          disabled={qtyLoading}
          type="submit"
          className="disabled:cursor-not-allowed disabled:bg-blue-800 group relative bg-blue-700 inline-flex items-center justify-center p-0.5  text-sm font-medium text-white rounded-lg group hover:bg-blue-800 focus:outline-none "
        >
